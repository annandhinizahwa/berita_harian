                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control" placeholder="Subjek Berita" autofocus
                                            id="subjek" name="subjek" value="{{ old('subjek', $berita->subjek) }}" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <textarea id="isi" name="isi" class="form-control"  maxlength="100" rows="8" placeholder="Isi berita...">{{ old('isi', $berita->isi) }}</textarea>
